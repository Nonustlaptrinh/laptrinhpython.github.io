...
`        `>>> tinh\_binh\_phuong(5)

`        `25

`        `>>> tinh\_binh\_phuong(2.5)
...
print(tinh\_binh\_phuong.\_\_doc\_\_)
...
print("Điểm TB:", diem\_trung\_binh)

print("Là sinh viên:", la\_sinh\_vien)
...
bien\_linh\_hoat = 10           *# int*

print(type(bien\_linh\_hoat))   *# <class 'int'>*

bien\_linh\_hoat = "Hello"      *# str*  

print(type(bien\_linh\_hoat))   *# <class 'str'>*

bien\_linh\_hoat = 3.14         *# float*

print(type(bien\_linh\_hoat))   *# <class 'float'>*
...
print(f"so\_nguyen: {so\_nguyen} - {type(so\_nguyen)}")

print(f"so\_thuc: {so\_thuc} - {type(so\_thuc)}")  

print(f"chuoi: {chuoi} - {type(chuoi)}")

print(f"danh\_sach: {danh\_sach} - {type(danh\_sach)}")

print(f"la\_dung: {la\_dung} - {type(la\_dung)}")

**Kết quả:**

text

so\_nguyen: 42 - <class 'int'>

so\_thuc: 3.14159 - <class 'float'>

chuoi: Hello Python - <class 'str'>

danh\_sach: [1, 2, 3] - <class 'list'>

la\_dung: True - <class 'bool'>
...
dat\_chuan = (diem\_toan >= 5) and (diem\_van >= 5)

hoc\_sinh\_gioi = (diem\_toan >= 8) or (diem\_van >= 8)

print(f"Đạt chuẩn: {dat\_chuan}")        *# True*

print(f"Học sinh giỏi: {hoc\_sinh\_gioi}") *# True*
...
print(f"3 in {danh\_sach}: {3 in danh\_sach}")       *# True*

print(f"10 in {danh\_sach}: {10 in danh\_sach}")     *# False*

print(f"10 not in {danh\_sach}: {10 not in danh\_sach}") *# True*
